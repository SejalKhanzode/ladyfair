...
export default function Home() {
  ...
  return (
    <div className="bg-pink3 h-screen flex flex-col ">
      <div className="">
        <div className=" flex flex-col md:flex-row w-full gap-4">
          <div className=" absolute flex flex-col items-center justify-center space-y-3">
            <div className="relative"></div>
            <p className="pt-12 text-4xl font-alata font-bold px-5 md:px-10 text-[#263238] max-w-[560px] text-">
            ...
            <div className="text-rose-600 text-[2rem] absolute left-0 font-bold text-center pl-28 pt-[35rem]">Book Now</div>
          </div>
          <img src={home} className=" h-[700px] md:h-[500px] w-full md:w-auto pb-14 cover  object-cover lg:w-full" />
        </div>
      </div>
      ...
      <div className="flex justify-center pb-5">
        ...
        <button className={`ml-3 bg-pink1 text-white font-bold px-6 py-2 rounded-md ${showLogin ? 'hidden' : 'block'}`} onClick={toggleLogin}>Book Now</button>
