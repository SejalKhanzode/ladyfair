...
import bride4 from '../../assets/bride4.jpeg'
...
const product = {
    ...
    description:
      'Welcome to our bridal makeup services, where beauty meets customization. We specialize in creating personalized bridal looks that reflect each brides unique style and vision for their special day. Our professional makeup artists are trained in the latest techniques and use high-quality products to ensure a flawless and long-lasting finish.',
    highlights: [
    ...
    details:
      'Offer different packages tailored to the brides needs, including options for engagement parties, bridal showers, and the wedding day itself.',
  }
